(function () {
  ...
  if (!c) { window.location.replace('courses.html'); return; }
  document.title = c[0] + ' | JobSkillShare';
  var signup = 'https://www.jobskillshare.org/';
...
(function () {
  var siteShell = document.createElement('script');
  siteShell.src = 'site-shell.js';
  document.body.appendChild(siteShell);
})();
